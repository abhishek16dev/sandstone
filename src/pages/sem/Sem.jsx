      ...
      <div className="container_2">
        ...
        <div className='c2_para'>
          ...
          <ul className='c2_list'>
            <li>
              <div className='tick_mark'> <span className='tick text-[white]'> &#10003;</span></div><b>Expertise in </b> We have a team of professionals experienced in creating and optimizing paid search campaigns. Their
